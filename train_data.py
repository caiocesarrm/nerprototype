...
('voce quer ir a a ou ao b', {'entities': [(13, 14, 'MISC'), (23, 24, 'MISC')]}),
('voce quer ir a b ou ao c', {'entities': [(15, 16, 'MISC'), (2, 3, 'MISC')]}),
('voce quer ir a c ou ao casa da vo', {'entities': [(2, 3, 'MISC'), (23, 33, 'MISC')]}),
...
('voce gostar a ou b', {'entities': [(9, 10, 'MISC'), (17, 18, 'MISC')]}),
('o resultado é a b ou c', {'entities': [(8, 9, 'MISC'), (16, 17, 'MISC'), (21, 22, 'MISC')]}),
('voce gostar b ou c', {'entities': [(12, 13, 'MISC'), (2, 3, 'MISC')]}),
('o resultado é b c ou brincar', {'entities': [(14, 15, 'MISC'), (16, 17, 'MISC'), (21, 28, 'MISC')]}),
('voce gostar c ou brincar', {'entities': [(2, 3, 'MISC'), (17, 24, 'MISC')]}),
('o resultado é c brincar ou correr', {'entities': [(14, 15, 'MISC'), (16, 23, 'MISC'), (27, 33, 'MISC')]}),
